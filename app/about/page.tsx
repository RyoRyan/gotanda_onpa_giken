...
export default function Home() {
  return (
    <div className="leading-relaxed space-y-6">
      ...
      <p>
        五反田音響波動技術研究所は、この認識のもとに令和八年に始動した。
        <br />
        我々の任務は、ギター改造、エフェクター自作、音響研究を表向きの活動としつつ、その実、響きの背後に潜む波動秩序を観測し、調律し、必要に応じて増幅することにある。
        <br />
        抵抗値、コンデンサ容量、磁性体の配置、筐体の共振、配線長、接点の状態――これらはすべて重要である。だが重要なのはそれだけではない。
        <br />
        部品が持つ固有の癖、製作者の精神状態、演奏者の集中、空間に残留した情動、時間帯、湿度、視線、執念。そのすべてが出音に関与している。
      </p>
      ...
      <p>
        ...
        <br />
        逆に、正しく調律された響きは、思考を澄ませ、衝動を鎮め、空間の位相を静め、対立の振幅を減衰させる。
        <br />
        一台の装置を整えることは、一人の内部宇宙を整えることに等しい。
        <br />
        一人の内部宇宙が整えば、その波及は決してそこで終わらない。
        <br />
        世界平和とは、遠い理想ではない。
        <br />
      ...
      <p>
        我々は、この仮説を仮説のまま放置しない。
        <br />
        回路を組む。測定する。比較する。試聴する。失敗する。再調整する。
        <br />
        そして、数式の外で脈打つ説明不能の変化を、説明不能のまま捨てずに保持する。
        <br />
        それが研究である。
        <br />
